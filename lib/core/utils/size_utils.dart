...
const num designWidth = 390;
const num designHeight = 844;
...
class SizeUtils {
  ...
  static void setScreenSize(
    ...
    if (orientation == Orientation.portrait) {
      width =
          boxConstraints.maxWidth.isNonZero(defaultValue: designWidth);
      height = boxConstraints.maxHeight.isNonZero();
    } else {
      width =
          boxConstraints.maxHeight.isNonZero(defaultValue: designWidth);
...
extension ResponsiveExtension on num {
  ...
  /// height of the screen or widget according to the Viewport height.
  double get v =>
      (this * _height) / (designHeight - designStatusBar);
